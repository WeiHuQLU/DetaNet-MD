...
class VibrationalSpectrum:
    ...
    def __init__(
        ...
        self.data = data
        self.timestep = 0.5  # Convert to fs
...
class PowerSpectrum(VibrationalSpectrum):
    ...
    def __init__(self, data: np, resolution: int = 4096):
    ...
    def _get_data(self):
        ...
        """
        relevant_data = self.data['velocities']
...
class IRSpectrum(VibrationalSpectrum):
    ...
    def _get_data(self):
        ...
        relevant_data = self.data['dipole']   #[10000:]
...
class RamanSpectrum(VibrationalSpectrum):
    ...
    def _get_data(self):
        ...
        Returns:
            numpy.array: Array holding the dipole moment derivatives.
        """
        relevant_data = self.data['polarizability']
