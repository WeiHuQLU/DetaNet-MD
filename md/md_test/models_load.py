...
def model_force_energy (params='D:\My_code\detanet\\trained_param\qm12\\force_energy.pth',device:torch.device=torch.device('cuda')):
...
def model_energy(params='D:\My_code\detanet\\trained_param\qm12\\energy.pth',device:torch.device=torch.device('cuda')):
    model_energy = DetaNet(num_features=128,
                           ...
                           grad_type=None,
                           device=device)
    energy_trained_params = torch.load(params)
